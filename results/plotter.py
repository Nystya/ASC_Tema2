...
def main():
    ...
    with open("./gcc/results_gcc", "w") as out_file:
        out_file.write("NEOPT: ")
        out_file.write(str(neopt))
        out_file.write("\n")
        out_file.write("BLAS: ")
        out_file.write(str(blas))
        out_file.write("\n")
        out_file.write("OPTM: ")
        out_file.write(str(optm))
        out_file.write("\n")
        out_file.write("OPTF: ")
        out_file.write(str(optf))
        out_file.write("\n")
    
    with open("./icc/results_icc", "w") as out_file:
        out_file.write("NEOPT: ")
        out_file.write(str(neopt_icc))
        out_file.write("\n")
        out_file.write("BLAS: ")
        out_file.write(str(blas_icc))
        out_file.write("\n")
        out_file.write("OPTM: ")
        out_file.write(str(optm_icc))
        out_file.write("\n")
        out_file.write("OPTF: ")
        out_file.write(str(optf_icc))
        out_file.write("\n")
